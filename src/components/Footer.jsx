...
const Footer = ({ onNavigate }) => {
  ...
  return (
    <footer className="bg-ink border-t border-ink/80">
        ...
        <div className="py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-stone mb-2 text-sm font-medium">
          ...
          {/* Resources Section */}
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mt-8 pt-8 border-t border-slate/30">
            <div>
              <a
          ...
          <div className="mt-8 pt-8 border-t border-slate/30">
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <p className="text-slate text-sm mt-2 md:mt-0">
