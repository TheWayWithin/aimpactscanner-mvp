-- Coffee Tier Infrastructure Migration
-- Adds tier management, usage tracking, and subscription support
...
-- Create indexes for efficient tier queries
...
BEGIN
    ...
    SELECT monthly_analyses_used, monthly_reset_date INTO current_count
    FROM users 
    WHERE id = user_uuid;
